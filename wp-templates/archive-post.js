...
import { CTA, NavigationMenu, PostCard } from "components";
import {
  BLOG_INFO_FRAGMENT,
...
export default function Component() {
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto grid max-w-4xl md:grid-cols-2">
        {posts.map((post) => {
...
Component.query = gql`
  query NewsPage(
    ...
    page(id: 340, idType: DATABASE_ID, asPreview: $asPreview) {
      id
      title
      seo {
        ...SEOFragment
